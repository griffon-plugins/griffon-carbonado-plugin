...
----
dependencies {
    griffon '{project-group}:griffon-carbonado-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-carbonado-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-carbonado-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-carbonado-plugin` BOM in your POM file, by placing the following
